...
class Outcome(models.Model):
    ...
    accounting_additional = models.ForeignKey(Additional, on_delete=models.CASCADE, null=True, blank=True)
    accounting_adjunct = models.ForeignKey(Adjunct, on_delete=models.SET_NULL, null=True, blank=True)
